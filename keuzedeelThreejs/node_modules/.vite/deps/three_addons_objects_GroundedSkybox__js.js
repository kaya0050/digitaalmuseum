import { Fo as SphereGeometry, Fs as Vector3, Qr as MeshBasicMaterial, Zr as Mesh } from "./three.core-DVx0lc9k.js";
//#region node_modules/three/examples/jsm/objects/GroundedSkybox.js
/**
...
var GroundedSkybox = class extends Mesh {
	...
	*/
	constructor(map, height, radius, resolution = 128) {
		if (height <= 0 || radius <= 0 || resolution <= 0) throw new Error("GroundedSkybox height, radius, and resolution must be positive.");
